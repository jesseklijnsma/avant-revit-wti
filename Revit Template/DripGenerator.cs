...
namespace RevitTemplate
{
    internal class DripGenerator
    {
        ...
        private List<Pipe> generateBranch(Pipe source, RectangleF areaRect, XYZ rootVector, XYZ perpendicularVector, List<XYZ> columnpoints, bool preview = false)
        {
            ...
            if (offcenter)
            {
                p4 = GeomUtils.getClosestPoint(Line.CreateUnbound(valve_transport_corner_out_p, rootVector), p5);
            ...
            if (!preview)
            {
                ...
                //{
                    ...
                    l9 = Pipe.CreatePlaceholder(this.data.doc, this.data.transportSystemType.Id, this.data.pipetype.Id, this.data.groundLevel.Id, p5, tee);
